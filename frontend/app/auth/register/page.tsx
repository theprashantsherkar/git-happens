...
//         }
//         @keyframes legSwingF { from { transform: rotate(-22deg); } to { transform: rotate(18deg); } }
//         @keyframes legSwingB { from { transform: rotate(18deg);  } to { transform: rotate(-22deg); } }
//         @keyframes armSwing  { from { transform: rotate(-18deg); } to { transform: rotate(22deg);  } }
//         @keyframes hammerUp  { from { transform: rotate(-80deg) translateY(0);   } to { transform: rotate(-40deg) translateY(-4px); } }
//         @keyframes swordSlash { from { transform: rotate(-55deg); } to { transform: rotate(-25deg); } }
//         @keyframes pickSwing  { from { transform: rotate(-65deg); } to { transform: rotate(-30deg); } }
...
//           to   { opacity: 0;   transform: translateY(-8px) scale(1.5); }
//         }
...
//           top: 14px; left: -2px; right: -2px; height: 6px;
...
//           clip-path: polygon(0 0, 100% 22%, 100% 78%, 0 100%);
//         }
//         .blue-legs { position: relative; width: 24px; height: 28px; margin: 0 auto; }
//         .blue-leg-l {
...
//           background: #0d47a1; border-radius: 0 3px 3px 0;
//         }
//         .blue-foot-l { left: -2px; }
//         .blue-foot-r { right: -2px; transform: scaleX(-1); }
...
//           border-radius: 2px;
//         }
//         .red-legs { position: relative; width: 21px; height: 26px; margin: 0 auto; }
//         .red-leg-l {
//           position: absolute; left: 1px; top: 0;
...
//         }
//         .green-legs { position: relative; width: 20px; height: 24px; margin: 0 auto; }
//         .green-leg-l {
//           position: absolute; left: 1px; top: 0;
//           width: 9px; height: 22px;
//           background: linear-gradient(180deg, #1b5e20, #2e7d32);
//           border-radius: 4px;
//           animation: legSwingF 0.38s ease-in-out infinite alternate;
//           transform-origin: top center;
//         }
//         .green-leg-r {
//           position: absolute; right: 1px; top: 0;
...
//           background: linear-gradient(180deg, #1b5e20, #2e7d32);
//           border-radius: 4px;
//           animation: legSwingB 0.38s ease-in-out infinite alternate;
//           transform-origin: top center;
//         }
...
//           border-radius: 4px;
//           transform-origin: bottom center;
//           animation: pickSwing 0.55s ease-in-out infinite alternate;
//         }
//         .pick-head {
...
//         }
//         .yellow-legs { position: relative; width: 19px; height: 23px; margin: 0 auto; }
//         .yellow-leg-l {
//           position: absolute; left: 1px; top: 0;
//           width: 8px; height: 21px;
//           background: linear-gradient(180deg, #e65100, #bf360c);
//           border-radius: 4px;
//           animation: legSwingB 0.4s ease-in-out infinite alternate;
//           transform-origin: top center;
//         }
//         .yellow-leg-r {
//           position: absolute; right: 1px; top: 0;
...
//           background: linear-gradient(180deg, #e65100, #bf360c);
//           border-radius: 4px;
//           animation: legSwingF 0.4s ease-in-out infinite alternate;
//           transform-origin: top center;
//         }
...
//           margin: 2px auto 0;
//         }
//         .dust-cloud { display: flex; gap: 3px; justify-content: center; margin-top: 1px; }
//         .dust-puff {
...
//         }
//         .dust-puff:nth-child(2) { animation-delay: 0.12s; width: 8px; }
//         .dust-puff:nth-child(3) { animation-delay: 0.22s; width: 9px; }
...
//           {/* BLUE — flag carrier, running left toward center */}
//           <div className="figure" style={{ left: '14%', animationDuration: '0.32s' }}>
...
//           {/* RED — hammer chaser */}
//           <div className="figure" style={{ left: '34%', animationDuration: '0.29s', animationDelay: '0.05s' }}>
...
//           {/* GREEN — sword chaser */}
//           <div className="figure" style={{ left: '49%', animationDuration: '0.36s', animationDelay: '0.1s' }}>
...
//           <div className="explosion-fx" style={{ bottom: 14, left: '59%' }}>💥</div>

//           {/* YELLOW — pickaxe chaser */}
//           <div className="figure" style={{ left: '63%', animationDuration: '0.33s', animationDelay: '0.15s' }}>
