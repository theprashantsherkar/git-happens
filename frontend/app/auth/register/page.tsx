...
//             0 0 20px rgba(255, 107, 26, 0.55),
//             1px 1px 0 #000,
//             -1px -1px 0 #000;
//           animation: bulletFloat 2s ease-in-out infinite alternate;
//           filter: drop-shadow(0 2px 6px rgba(0,0,0,0.8));
//         }

//         .info-bullet:nth-child(1) { animation-delay: 0s; }
//         .info-bullet:nth-child(2) { animation-delay: 0.3s; }
//         .info-bullet:nth-child(3) { animation-delay: 0.6s; }
//         .info-bullet:nth-child(4) { animation-delay: 0.9s; }
...
//         {/* Game info — floating bullet points, no boxes */}
//         <div className="game-info">
//           <div className="info-bullet">
//             <span className="info-bullet-icon">👥</span>
//             <span><strong>4 Players</strong> · free-for-all</span>
//           </div>
//           <div className="info-bullet">
//             <span className="info-bullet-icon">🚩</span>
//             <span>Hold the flag the <strong>longest</strong> to win</span>
//           </div>
//           <div className="info-bullet">
//             <span className="info-bullet-icon">⚔️</span>
//             <span>Flag <strong>or</strong> weapon — not both</span>
//           </div>
//           <div className="info-bullet">
//             <span className="info-bullet-icon">⏱</span>
//             <span><strong>5 min</strong> matches · first to dominate wins</span>
//           </div>
//         </div>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ─── PAGE ─── */
        /* pad enough to keep everything visually inside the decorative border frame (8px offset + 3px border + ~18px breathing room = 30px) */
        .page {
          position: relative; z-index: 10;
          min-height: 100vh;
          display: flex; flex-direction: column;
        ...
        /* ─── GAME INFO — horizontal floating bullets ─── */
        .game-info {
          display: flex;
          flex-direction: row;
          flex-wrap: wrap;
        ...
        .info-bullet:nth-child(1) { animation-delay: 0s; }
        .info-bullet:nth-child(3) { animation-delay: 0.25s; }
        .info-bullet:nth-child(5) { animation-delay: 0.5s; }
        .info-bullet:nth-child(7) { animation-delay: 0.75s; }

        /* glowing separator between bullets */
        .info-sep {
          font-family: 'VT323', monospace;
          font-size: 20px;
          color: rgba(255, 107, 26, 0.75);
          text-shadow: 0 0 10px rgba(255,107,26,0.6);
          user-select: none;
          animation: bulletFloat 2s ease-in-out infinite alternate;
      ...
      <main className="page">
        ...
        {/* Game info — all 4 bullets in one horizontal row with separators */}
        <div className="game-info">
          <div className="info-bullet">
            <span className="info-bullet-icon">👥</span>
            <span><strong>4 Players</strong> · free-for-all</span>
          ...
          <div className="info-bullet">
            <span className="info-bullet-icon">🚩</span>
            <span>Hold flag the <strong>longest</strong></span>
          </div>
          <span className="info-sep">✦</span>
          <div className="info-bullet">
            <span className="info-bullet-icon">⚔️</span>
          ...
          <div className="info-bullet">
            <span className="info-bullet-icon">⏱</span>
            <span><strong>5 min</strong> matches</span>
          </div>
        </div>

        {/* Register panel — padded to sit visually inside the border frame */}
        <div className={`panel ${shake ? 'shake' : ''}`}>
          <div className="panel-corner tl" /><div className="panel-corner tr" />
          <div className="panel-corner bl" /><div className="panel-corner br" />
